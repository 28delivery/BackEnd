...
//        if (testInfo.getTestMethod().isPresent() && !testInfo.getTestMethod().get().getName()
//            .equals("testLoginSuccess")) {
...
//
//        when(userRepository.findByUsernameAndIsDeletedFalse(username)).thenReturn(
//            Optional.of(user));
