...
import com.sparta.spring_deep._delivery.domain.restaurant.service.RestaurantAdminService;
...
public class RestaurantAdminController {
    ...
    public ResponseEntity<RestaurantAdminResponseDto> getRestaurant(
        ...
        RestaurantAdminResponseDto restaurantAdminResponseDto = restaurantAdminService.getRestaurant(
            restaurantId);
    ...
    public ResponseEntity<RestaurantAdminResponseDto> addRestaurant(
        ...
        RestaurantAdminResponseDto restaurantAdminResponseDto = restaurantAdminService.createRestaurant(
    ...
    public ResponseEntity<RestaurantAdminResponseDto> updateRestaurant(
        ...
        RestaurantAdminResponseDto restaurantAdminResponseDto = restaurantAdminService.updateRestaurant(
            restaurantId, restaurantAdminRequestDto);
        return ResponseEntity.status(HttpStatus.OK).body(restaurantAdminResponseDto);
    }
    ...
    public ResponseEntity<String> deleteRestaurant(
        ...
        if (restaurantAdminService.deleteRestaurant(restaurantId)) {
